...
_The arm character in our prototype waving from first person view_
...
Thinking from this, we came up with a mechanic which would use non-conscious, internalised behaviour to direct limbs’ motion, rather than real-time conscious decisions:
