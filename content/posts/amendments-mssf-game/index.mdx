...
<Video
  videoSrcURL="https://www.youtube.com/embed/edy_apZU8Ko"
  videoTitle="Move Split Stick Flip Game"
/>

During our [first design session](https://figureable.netlify.com/design-session-01) earlier this month, we spent a considerable chunk of our time playing and rethinking our [move-split-stick-flip game prototype](https://figureable.netlify.com/game-concept-move-split-stick-flip). Soon after we also tested the game out with some friends.
