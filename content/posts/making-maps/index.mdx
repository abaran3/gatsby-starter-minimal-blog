...
![Visual References](./maps-inspiration.png)
...
You return to the central room and connect to your body. You now have a resolve to find the control room, and try and pull that lever. The map below sketches out the paths that each of the body parts would follow for succesful completion of their task.

![Character journey](./character_journey.png)
