...
Birth is often seen as multiplication. But it can be seen as a subtraction of the mother.
We thought of a womb as a trap. And birth in to the spawning process in game mechanics. Ie: A shooter when you respawn you go through the birth canal. Pregnancy as a form of self-vulnerability.
...
We borrow the ideas of the work / labor divide from Arendt. Where labor is concerned with creating consumable products, the creation of 'work' is for the long run. It's products durable and permanent. However, this boundary is much closer together than when she originally wrote about this.

We have now an environment where our furniture becomes consumable (I gave away my bed when I moved from NL to Berlin, only to buy the same one again on moving here), Our clothes turned in to fast fashion, and our TV on demand. This takes away a key point of the idea of durability. A durable item is one that is independent of the whims of people. Value is fleeting and functionality is impermanent.
